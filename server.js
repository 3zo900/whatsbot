...
<html lang="ar" dir="rtl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>WhatsBot AI</title><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@400;500;700&display=swap" rel="stylesheet">
<style>*{margin:0;padding:0;box-sizing:border-box;font-family:'IBM Plex Sans Arabic',sans-serif}body{background:#f8fffe;color:#111}nav{position:fixed;top:0;left:0;right:0;background:#fff;z-index:1000;padding:12px 5%;display:flex;justify-content:space-between;align-items:center;box-shadow:0 2px 10px rgba(0,0,0,.05)}.logo{display:flex;align-items:center;gap:8px;font-weight:800;font-size:18px}.hero{padding:140px 5% 60px;text-align:center;background:linear-gradient(180deg,#e8f5e9 0%,#fff 100%)}.hero h1{font-size:32px;line-height:1.3;margin-bottom:16px}.hero h1 span{color:#22C55E}.hero p{color:#666;max-width:600px;margin:0 auto 24px}.btn{display:inline-block;padding:12px 24px;border-radius:10px;text-decoration:none;font-weight:700;cursor:pointer;border:none}.btn-g{background:#22C55E;color:#fff}.btn-w{background:#fff;color:#111;border:1px solid #ddd}.plans{padding:40px 5%;display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;max-width:1100px;margin:0 auto}.plan{background:#fff;border:1px solid #eee;border-radius:16px;padding:24px;position:relative}.plan.pop{border:2px solid #22C55E;transform:scale(1.02)}.plan h3{font-size:20px;margin-bottom:8px}.price{font-size:28px;font-weight:800;margin:12px 0}.price small{font-size:14px;color:#666}.plan ul{list-style:none;margin:16px 0}.plan li{padding:6px 0;color:#444;font-size:14px}.plan li:before{content:'✓ ';color:#22C55E;font-weight:800}</style></head><body>
<nav><div class="logo"><div style="width:42px;height:42px;background:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;padding:2px"><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><g fill="#22C55E"><path d="M18 14 C8 14 2 20 2 30 L2 76 L18 76 L18 32 Q18 22 26 22 Z"/><path d="M28 4 Q24 4 22 8 Q20 12 22 16 L38 66 Q40 70 44 70 Q48 70 50 66 L60 30 L70 66 Q72 70 76 70 Q80 70 82 66 L98 16 Q100 12 98 8 Q96 4 92 4 L88 4 L72 52 L60 8 Q60 4 52 4 Q44 4 44 8 L28 52 Z"/><path d="M76 20 Q92 20 96 36 Q96 50 82 54 L60 54 Q50 54 48 60 Q48 66 58 66 L82 66 Q100 66 100 84 Q100 100 82 100 L6 100 L2 94 L0 76 L6 74 L82 74 Q88 74 88 70 Q88 66 82 66 L56 66 Q40 66 40 54 Q40 42 56 42 L76 42 Q84 42 84 36 Q84 30 76 30 Z"/></g></svg></div> WhatsBot AI</div><div><a href="/order?plan=starter" class="btn btn-g">ابدأ الان</a></div></nav>
<div class="hero"><h1>بوت واتساب ذكي <span>يبيع ويرد عنك 24/7</span></h1><p>حول واتساب متجرك لموظف مبيعات ذكي يفهم لهجتك ويرد على عملاءك حتى وانت نايم</p><div><a href="/order?plan=pro" class="btn btn-g">جرب 14 يوم مجانا</a> <a href="https://wa.me/966510015157" class="btn btn-w">شاهد ديمو</a></div></div>
<div class="plans">
<div class="plan"><h3>باقة الافراد</h3><div class="price">89 <small>ريال/شهريا</small></div><ul><li>1000 محادثة AI</li><li>بوت واحد</li><li>لوحة تحكم بسيطة</li><li>دعم فني</li></ul><a href="/order?plan=individual" class="btn btn-g" style="width:100%;text-align:center">اطلب الباقة</a></div>
<div class="plan pop"><h3>باقة الشركات ⭐ الاكثر طلبا</h3><div class="price">189 <small>ريال/شهريا</small></div><ul><li>7000 محادثة AI</li><li>3 بوتات</li><li>تحويل للموظفين</li><li>تقييم العملاء</li><li>ربط واتساب QR</li></ul><a href="/order?plan=companies" class="btn btn-g" style="width:100%;text-align:center">اطلب الباقة</a></div>
<div class="plan"><h3>باقة المؤسسات</h3><div class="price">399 <small>ريال/شهريا</small></div><ul><li>محادثات غير محدودة</li><li>بوتات غير محدودة</li><li>API خاص</li><li>مدير حساب مخصص</li><li>تدريب مخصص</li></ul><a href="/order?plan=enterprise" class="btn btn-g" style="width:100%;text-align:center">اطلب الباقة</a></div>
</div>
</body></html>`);
});
...
app.post('/api/order', (req,res)=>{
  ...
  console.log('ORDER:', {name,storeName,email,whatsapp,type,clients,plan});
  users.push({id:Date.now(), phone:whatsapp, password:'123456', name:storeName, plan:plan||'individual', ai_credits:plan==='companies'?7000:1000, used_credits:0, expiry:'2026-12-31', status:'pending', whatsapp, email, type, clients, issue});
...
function refreshData(){
  ...
  if(document.getElementById('setClients')) document.getElementById('setClients').value = currentUser.dailyClients || '20-50';
}
