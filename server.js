...
<section class="hero">
  ...
  <div class="btns">
    <a href="https://wa.me/${SUPPORT_NUMBER}?text=مرحبا%20اريد%20الاشتراك%20في%20WhatsBot" class="btn btn-green">ابدأ الآن - واتساب</a>
...
<section id="pricing" class="pricing">
  ...
  <div class="plans">
    <div class="plan">
      ...
      <a href="https://wa.me/${SUPPORT_NUMBER}?text=اريد%20باقة%20الافراد%20109" class="btn btn-white" style="width:100%;text-align:center;margin-top:10px">اشترك</a>
    </div>
    <div class="plan featured">
      ...
      <a href="https://wa.me/${SUPPORT_NUMBER}?text=اريد%20الباقة%20الاحترافية%20199" class="btn btn-green" style="width:100%;text-align:center;margin-top:10px">الأكثر طلباً</a>
    </div>
    <div class="plan">
      <h3>شركات</h3>
      ...
      <a href="https://wa.me/${SUPPORT_NUMBER}?text=اريد%20باقة%20الشركات%20399" class="btn btn-white" style="width:100%;text-align:center;margin-top:10px">للشركات</a>
    </div>
  </div>
</section>
...
<footer>
  ...
  <p>تواصل: <a href="https://wa.me/${SUPPORT_NUMBER}">${SUPPORT_NUMBER}</a> | ${DOMAIN}</p>
