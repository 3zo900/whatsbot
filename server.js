...
<div class="plan pop"><h3>⭐ باقة الشركات - الاكثر طلبا</h3><div class="price">189 <small>ريال/شهريا</small></div><ul><li>7000 محادثة AI</li><li>3 بوتات</li><li>تحويل للموظفين</li><li>تقييم العملاء</li><li>ربط واتساب QR</li><li>دعم اولوية</li></ul><a href="/order?plan=companies" class="btn btn-g" style="width:100%;text-align:center">اطلب الباقة - الاكثر طلبا</a></div>
<div class="plan"><h3>باقة المؤسسات</h3><div class="price">399 <small>ريال/شهريا</small></div><ul><li>محادثات غير محدودة</li><li>بوتات غير محدودة</li><li>API خاص</li><li>مدير حساب مخصص</li><li>تدريب مخصص</li><li>واتساب غير محدود</li></ul><a href="/order?plan=enterprise" class="btn btn-g" style="width:100%;text-align:center">اطلب الباقة</a></div>
</div>
</body></html>`);
});
